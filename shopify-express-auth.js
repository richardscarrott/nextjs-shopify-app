...
export default function applyAuthMiddleware(
  ...
  app.get("/api/auth/toplevel", (req, res) => {
    // Why does this set a cookie w/ value 1? It must just indicate we've been here and dropped a cookie
    // which I guess app bridge does some other shit?
  ...
  app.get("/api/auth/callback", async (req, res) => {
    try {
      ...
      // I guess this is where we would save the access_token in our sellers table?
      console.log("AFTER AUTH!!!!!::!");
      console.log(req.session, req.query, session);
